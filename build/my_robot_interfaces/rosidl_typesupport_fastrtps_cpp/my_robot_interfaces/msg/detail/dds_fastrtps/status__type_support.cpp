...
#include "my_robot_interfaces/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::msg::Status & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::msg::Status & ros_message)
{
  // Member: battery_level
  cdr >> ros_message.battery_level;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_Status__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, msg, Status)() {
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_Status__handle;
}
